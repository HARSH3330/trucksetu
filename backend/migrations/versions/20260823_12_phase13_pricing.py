...
def upgrade() -> None:
    ...
    op.bulk_insert(settings_table, [{"key": "trip_price_suggestion", "value": {"minimum_fare":"2500","per_km_rate":"50","loading_charge":"500","unloading_charge":"500","included_stops":2,"extra_stop_charge":"500","night_charge":"500","free_waiting_hours":"1","waiting_charge_per_hour":"500","range_percent":"10"}}])
